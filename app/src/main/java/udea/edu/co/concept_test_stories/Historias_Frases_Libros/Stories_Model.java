...
public class Stories_Model implements IStories_Phrases.IInteractor {
    ...
    public void getStories() {
        ...
        retrofit2.Call<ArrayList<Story>> call = iStoryAPI.getStories();

        call.enqueue(new Callback<ArrayList<Story>>() {
            @Override
            public void onResponse(retrofit2.Call<ArrayList<Story>> call, Response<ArrayList<Story>> response) {
            ...
            @Override
            public void onFailure(retrofit2.Call<ArrayList<Story>> call, Throwable t) {
